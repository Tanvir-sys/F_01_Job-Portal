<?php
   ...
   $Admnquery=mysqli_query($con, "SELECT * FROM users WHERE Chose_optn ='2'");
...
<header>
    ...
    <a class="navbar-brand" href="Jobseekerlist.php">JOB-PORTAL</a>
...
<br>
  ...
  <div class="contaner">
     <div class="">
         ...
         <div class="type">
            <h1 style="color:black; margin-left:200px;" >Job-Seeker-List</h1>
        </div>
